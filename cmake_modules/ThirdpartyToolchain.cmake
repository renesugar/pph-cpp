...
if (NOT "$ENV{PROJECT_BUILD_TOOLCHAIN}" STREQUAL "")
  set(THRIFT_HOME "$ENV{PROJECT_BUILD_TOOLCHAIN}")
  set(ARROW_HOME "$ENV{PROJECT_BUILD_TOOLCHAIN}")

  if (NOT DEFINED ENV{BOOST_ROOT})
    # Since we have to set this in the environment, we check whether
    # $BOOST_ROOT is defined inside here
    set(ENV{BOOST_ROOT} "$ENV{PROJECT_BUILD_TOOLCHAIN}")
  endif()
endif()
...
## GTest
if(PROJECT_BUILD_TESTS AND NOT IGNORE_OPTIONAL_PACKAGES)
...
if(PROJECT_BUILD_BENCHMARKS AND NOT IGNORE_OPTIONAL_PACKAGES)
...
if (NOT ARROW_FOUND)
  ...
  set(ARROW_CMAKE_ARGS
    ...
    -DARROW_BUILD_SHARED=${PROJECT_BUILD_SHARED}
    -DARROW_BOOST_USE_SHARED=${PROJECT_BOOST_USE_SHARED}
    -DARROW_BUILD_TESTS=OFF)

  if ("$ENV{PROJECT_ARROW_VERSION}" STREQUAL "")
    set(ARROW_VERSION "939957f33ed0dd02013917b366ff85eb857c3947")
  else()
    set(ARROW_VERSION "$ENV{PROJECT_ARROW_VERSION}")
  endif()
